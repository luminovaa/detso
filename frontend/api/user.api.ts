...
import { CreateUserFormData, UpdateUserFormData, User,  CreateUserTenantFormData } from "@/types/user.types";
...
export function createUserTenant(user: CreateUserTenantFormData) {
    return service({
